...
const Landing = () => {
  return (
    <main className='gradient'>
      <div tw="pt-8 pb-24">
        <div tw="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div tw="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <p tw="uppercase tracking-wider w-full">Vallant High School</p>
            <p tw="my-4 text-6xl font-bold leading-10">Vallant Vikings <span tw="text-opacity-25 text-gray-200"> Mens </span>Volleyball</p>
            <div tw="border-b border-gray-500 h-2 w-24 -ml-8 mb-4 -mt-2" />
            <p tw="leading-normal text-2xl mb-8">Vallant County, CA</p>
      ...
      <div tw="relative -mt-12 lg:-mt-24">
